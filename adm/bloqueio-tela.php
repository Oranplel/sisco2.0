			...
			<div class=" card-box">
				...
				<div class="panel-body">
					<form id="formulario" name="formulario" method="post" role="form" class="text-center"> 
                        ...
                        <img src="../fotos/<?php echo $_SESSION['imgUser'];?>" alt="contact-img" title="contact-img" class="img-circle thumb-sm" />
						...
						<div class="form-group">
                            ...
                            if (isset($_POST[env])) {
                                ...
                                $usuario = $_POST['email'];
                                $senha = $_POST['senha'];
                                $queryvalidar = "select * from tb_usuario where idtb_usuario = $_SESSION[id] and senha_usuario='$senha'";
