    ...
    <div class="moving_header2 topbar">
        ...
        <div class="topbar-left">
            <div class="text-center">
                <a href="index.php" class="active logo"><img class="logosisco2" src="../assets/images/espinho_azul.ico" alt=""><span>ISCO²</span></a>
            </div>
        </div>

        <!-- Button mobile view to collapse sidebar menu -->
        <div class="navbar navbar-default" style="background-color: #00ccffff;" role="navigation">
            <div class="container">
                <div class="">
                    <div class="pull-left">
