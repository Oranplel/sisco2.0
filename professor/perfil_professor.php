            ...
            <div class="content-page">
                ...
                <div class="content">
                         ...
                         <?php
                           ...
                           $sql = "SELECT * FROM tb_usuario where idtb_usuario = $_SESSION[id2]";
                        ...
                        <div class="col-sm-12">
                            <div class="bg-picture text-center">
                                <div class="profile-info-name">
                                    ...
                                    <h4 class="m-b-5"><b>Professor</b></h4>
	                                    ...
	                                    <div class="time-item">
	                                        <div class="item-info">
	                                            ...
	                                            <p><strong><?php echo "<p></p>",$row['senha_usuario'];?></strong></p>
                                                                     ...
                                                                     <hr>
                                                                     <a href="alterar_prof.php?id=<?php echo $row['idtb_usuario'] ;?>"><button type="submit" class="btn btn-default in" style="float:right">Atualizar informações</button></a>
                                                <br>
								</div>
