...
echo "<meta charset=utf-8><script language='javascript' type='text/javascript'>alert('Ocorreu um erro') </script>";
header("Location: ../manu-user.php");
 //window.location.href=\"../manu-user.php\";
...
if ($_FILES['arquivo']['error'] == 4) {
	...
	//echo"<script>window.location=\"../perfil_professor.php\"</script>" ;
