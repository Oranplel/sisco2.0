...
$_SESSION['id'] =$_COOKIE['id2'];
    $_SESSION['emailUser'] =$_COOKIE['usuario2'];
    $_SESSION['nomeUser'] = $_COOKIE['nome2'];
    $_SESSION['imgUser'] = $_COOKIE['img2'];
 }else{
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="perfil_professor.php" class="active"><i class="ti-user"></i><span> Perfil </span></a>
                            </li>
                        </ul>
                        ...
                        <div class="panel-body">
                            <div class="row"><div class="col-md-2"></div>
                                <div class="col-md-8">
                                    ...
                                    <form name="form_alterar" method="post" action="dao/alterar_prof.php" enctype="multipart/form-data">
                                    <?php
                                        $idAlt = $_GET['id'];
                                    ...
                                    ?>
                                      ...
                                      <div class="col-md-6"><br><br><br></div>
                                        ...
                                        <a href="perfil_professor.php"><button type="button" style="float:right" class="btn btn-inverse">Cancelar</button></a>
