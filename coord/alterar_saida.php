...
<html>
                ...
                <div class="row">
                    <div class="col-md-12">
                     <h2>Alteração de dados</h2>   
                        <h5>Altere os dados da saida.</h5>
 ...
 <form name="form_alterar" method="post" action="dao_front/alterar_sai.php">
                        
     
     
                            <?php  
                              $idAlt = $_GET['id'];
                              $sql = "SELECT idtb_aluno, idtb_saida, data_saida, hora_saida, responsavel_saida FROM tb_aluno, tb_saida WHERE tb_saida.tb_aluno_idtb_aluno = tb_aluno.idtb_aluno AND idtb_saida = $idAlt";
             ...
             <div class="content">
                    <div class="container">
						...
						<input type="hidden" class="form-control" readonly="true" name="id" value="<?php echo $row['idtb_saida'];?>">
					</div>
                                          </div>
                                          <br>
                                          </center> 
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="data"  value="<?php echo $row['data_saida'];?>">
						<span class="input-group-addon bg-custom b-0 text-white"><i class="icon-calender"></i></span>
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" name="hora"  value="<?php echo $row['hora_saida'];?>">
                                       ...
                                       <div class="col-md-12">
                                           <br>
                                           <label for="fone">Responsável:</label>
                                       <div class="input-group">
                                            <input class="form-control" name="resp"  value="<?php echo $row['responsavel_saida'];?>" >
