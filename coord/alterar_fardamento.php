    ...
    <body class="fixed-left">
        ...
        <div id="page-wrapper" >
                ...
                <div class="row">
                    <div class="col-md-12">
                     <h2>Alteração de dados</h2>   
                        <h5>Altere os dados do fardamento.</h5>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row"><div class="col-md-2"></div>
                               ...
                               <form name="form_alterar" method="post" action="dao_front/alterar_farda.php">
                   
              
                                   <?php

                                        $idAlt = $_GET['id'];
                                        $sql = "SELECT idtb_aluno, idtb_fardamento, data_farda, motivo_farda, obs_farda FROM tb_aluno, tb_fardamento WHERE tb_fardamento.tb_aluno_idtb_aluno = tb_aluno.idtb_aluno AND idtb_fardamento = $idAlt";
           ...
           <input value="<?php echo $row['idtb_aluno'];?>" name="idal" type="hidden">
						...
						<input type="hidden" class="form-control" readonly="true" name="id" value="<?php echo $row['idtb_fardamento'];?>">
                                          ...
                                          <br>
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="data"  value="<?php echo $row['data_farda'];?>">
						<span class="input-group-addon bg-custom b-0 text-white"><i class="icon-calender"></i></span>
                                       ...
                                       <div class="input-group">
                                            <input class="form-control" name="motivo"  value="<?php echo $row['motivo_farda'];?>" >
                                       ...
                                       <div class="col-md-12">
                                            <br>
                                            <label id="email">Observações:</label>
                                        <div class="input-group">
                                            <textarea class="form-control" name="obs"><?php echo $row['obs_farda'];?></textarea>
                                            <span class="input-group-addon bg-custom b-0 text-white"><i class=" ti-plus "></i></span>
                                       </div>
                                            <br> <br> <br> 
                                        </div>
