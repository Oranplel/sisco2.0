...
if (isset($_POST['enviar'])):
    ...
    $sql = "INSERT INTO tb_ocorrencia(tb_usuario_idtb_usuario, tb_aluno_idtb_aluno,tb_turma_idtb_turma,motivo_ocorrencia,obs_ocorrencia,nivel_ocorrencia,data_ocorrencia,hora_ocorrencia) VALUES ('".$row['tb_usuario_idtb_usuario']."', '$fild_aluno','$fild_turma','".$row['motivo_ocorrencia']."','".$row['obs_ocorrencia']."','g','".$row['data_ocorrencia']."','".$row['hora_ocorrencia']."')";
    $result = mysqli_query($mysqli, $sql);

    echo"<script> window.location=\"../historico_aluno.php?id=$fild_aluno\" </script>";
endif;
