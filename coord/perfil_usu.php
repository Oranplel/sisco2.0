            ...
            <div class="content-page">
                ...
                <div class="content">
                             ...
                             <?php  
                                $idO = $_GET['id'];
                                $idAlt = $_GET['aluno'];
                                $sql = "SELECT * FROM tb_usuario where idtb_usuario = $_SESSION[id3]";
                        ...
                        <div class="col-sm-12">
                            <div class="bg-picture text-center">
                                <div class="profile-info-name">
                                    ...
                                    <h4 class="m-b-5"><b>Coordenador</b></h4>
									...
									<div class="timeline-2">
	                                    <div class="time-item">
	                                        <div class="item-info">
	                                            ...
	                                            <p><strong><?php echo "<p></p>",utf8_encode($row['nome_usuario']);?></strong></p>
	                                        </div>
	                                    </div>
	                                    ...
	                                    <div class="time-item">
	                                        <div class="item-info">
	                                            ...
	                                            <p><strong ><?php echo "<p></p>",$row['senha_usuario'];?></strong></p>
                                                                     ...
                                                                     <hr>
                                                                     <a href="alterar_coordenador.php?id=<?php echo $row['idtb_usuario'] ;?>"><button type="submit" class="btn btn-default in" style="float:right">Atualizar informações</button></a>
                                                <br>
								</div>
