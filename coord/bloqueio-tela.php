			...
			<div class=" card-box">
				...
				<div class="panel-body">
					<form id="formulario" name="formulario" method="post" role="form" class="text-center"> 
                        ...
                        <img src="../fotos/<?php echo $_SESSION['imgUser3'];?>" alt="contact-img" title="contact-img" class="img-circle thumb-sm" />
                                             
						</div>
						<div class="form-group">
							<h3><?php echo $_SESSION['nomeUser3'];?></h3>
							<p class="text-muted">
                            ...
                            if (isset($_POST[env])) {
                                ...
                                $queryvalidar = "select * from tb_usuario where idtb_usuario = $_SESSION[id3] and senha_usuario='$senha'";
        ...
        <div class='alert alert-danger alert-dismissable'>
			...
			<div class="row">
				<div class="col-sm-12 text-center">
					<p>
						Deseja trocar usuário?<a href="dao_front/logout.php" class="text-primary m-l-5"><b>Login</b></a>
					</p>
				</div>
			</div>
